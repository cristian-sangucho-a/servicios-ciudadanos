...
Característica: Realización de actividades por ciudadanos
  ...
  Escenario: Reserva de un area comunal para actividad pública
    ...
    Cuando el ciudadano realice una reserva de tipo "publico" en el area comunal "Cancha #1" el "15/01/2024" de "16:00" a "17:00"
  ...
  Escenario: Reserva de un area comunal para una actividad privada
    Dado que existen areas comunales disponibles en el espacio publico "Parque la Alameda" en la ciudad y son
      ...
      | Cancha #3 |
    Y el ciudadano no supera las "3" reservas activas
    Cuando el ciudadano realice una reserva de tipo "privado" en el area comunal "Cancha #2" el "15/01/2024" de "10:00" a "12:00"
  ...
  Escenario: Cancelar reserva de actividad publica en area comunal
    Dado que el ciudadano tiene una reserva de tipo "publico" en el espacio publico "Parque la Alameda" en el area comunal "Cancha #3" el "15/01/2024" de "16:00" a "17:00"
  ...
  Escenario: Cancelar reserva de actividad privada en area comunal
    Dado que el ciudadano tiene una reserva de tipo "privado" en el espacio publico "Parque la Alameda" en el area comunal "Cancha #3" el "15/01/2024" de "7:00" a "8:00"
    Cuando cancele la reserva
