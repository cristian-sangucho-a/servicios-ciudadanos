...
def eliminar_inscripcion(request, registro_id):
    ...
    """
    print(f"\n=== Iniciando eliminación de inscripción ===")
    print(f"ID de registro a eliminar: {registro_id}")
    ...
    print(f"Evento del registro: {evento.nombre_evento}")
    
    try:
        print("Intentando cancelar inscripción...")
        registro_cancelado, registro_promovido = evento.cancelar_inscripcion(registro_id)
        print(f"Inscripción cancelada. Registro cancelado: {registro_cancelado}, Registro promovido: {registro_promovido}")
    ...
    print("=== Fin de eliminación de inscripción ===\n")
