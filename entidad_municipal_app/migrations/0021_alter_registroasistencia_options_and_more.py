# Generated by Django 5.1 on 2025-02-05 00:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('INSCRITO', 'Inscrito'), ('EN_ESPERA', 'En_Espera'), ('CANCELADO', 'Cancelado'), ('ASISTIO', 'Asistio'), ('NO_ASISTIO', 'No_Asistio')], default='INSCRITO', help_text='Estado actual del registro de asistencia', max_length=20, verbose_name='Estado del registro'),
        ),
        migrations.AlterField(
            model_name='registroasistencia',
            name='evento',
            field=models.ForeignKey(help_text='Evento al que se registra el ciudadano', on_delete=django.db.models.deletion.CASCADE, related_name='registros', to='entidad_municipal_app.eventomunicipal', verbose_name='Evento'),
        ),
        migrations.AlterField(
            model_name='registroasistencia',
